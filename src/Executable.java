...
public class Executable extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Scene scene = new Scene(root, gestionnaire.getLargeur() * largeurCaractere,
                gestionnaire.getHauteur() * hauteurTexte);
        scene.setFill(Color.color(0.0, 0.0, 0.2));
